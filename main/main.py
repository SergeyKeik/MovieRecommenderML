...
MODEL_PATH = Path("D:\Programming\MovieRecommenderApi\MovieRecommenderML\main\model.joblib")
MOVIES_PATH = Path("D:\Programming\MovieRecommenderApi\MovieRecommenderML\main\movies.csv")
TRAIN_DATA_PATH = Path("D:\Programming\MovieRecommenderApi\MovieRecommenderML\main\\ratings.npz")
